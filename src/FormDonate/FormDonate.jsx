...
//         await axios
//             .post('http://devdb.klabs.life/api/advises', {
//                 data: {
//                     phoneNumber,
//                     service,
//                     name,
...
//                     <DropDownHeader onClick={toggling}>{selectedOption || 'Service'}</DropDownHeader>
//                     {isOpen && (
...
//                 <label for="input" className="Input-label demand-text">
//                     Your demand
//                 </label>
//                 <br className="straight-line" />
//                 <textarea
//                     type="text message"
//                     className="Input-text input-demand"
...
//                 <button className="submit-demand" onClick={submitHandler}>
//                     Send Your Demand
//                 </button>
//             </div>
//         </div>
