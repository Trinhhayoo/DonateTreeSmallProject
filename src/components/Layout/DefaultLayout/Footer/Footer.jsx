            ...
            <div className="information-container">
                    <div className="inside-container">
                        <div className="divide-container">
                            ...
                            <span>
                            <img className=" logo-footer" src={logo} /></span>
                            ...
                            <div className="lien-he">
                                ...
                                <ul className="info">
                                    <li className="each-info">
                                        <span>
                                            <img className=" ic-footer img-dc " src={locate} /></span>
                                        <p className="foter-ic foter-dc">227 Nguyen Van Cu, district 5, Ho Chi Minh City</p>
                                    </li>
                                    ...
                                    <li className="each-info">
                                        ...
                                        <span>
                                            <img className="ic-footer img-mail " src={mail} /></span>
